...
SWIFT_ENUM_FWD_DECL(NSInteger, DKAssetType)
@class NSString;
@class CLLocation;
@class PHAsset;
...
SWIFT_ENUM_FWD_DECL(NSInteger, DKImageExportPresent)
...
SWIFT_ENUM_FWD_DECL(NSInteger, DKImageExtensionType)
...
SWIFT_ENUM_FWD_DECL(NSInteger, DKImagePickerControllerAssetType)
SWIFT_ENUM_FWD_DECL(NSInteger, DKImagePickerControllerSourceType)
@class DKPermissionViewColors;
SWIFT_ENUM_FWD_DECL(NSInteger, DKImagePickerControllerExportStatus)
...
@class UIView;
@class UIColor;
SWIFT_ENUM_FWD_DECL(NSInteger, DKImagePickerGroupListPresentationStyle)
