...
class _FolderListViewState extends State<FolderListView> with AutomaticKeepAliveClientMixin {
                ...
                return SliverFillRemaining(
                  ...
                  child: Center(
                    child: Column(
                      ...
                      children: [
                        Icon(Icons.folder_open_rounded, size: 64, color: isDark ? Colors.white10 : AppColors.border),
                    ...
                    delegate: SliverChildBuilderDelegate(
                      (context, index) {
                        ...
                        return FolderCard(
                          ...
                          onEdit: () => _showCreateFolderDialog(context, editFolder: folder),
  ...
  void _showCreateFolderDialog(BuildContext context, {FolderModel? editFolder}) {
    if (editFolder != null) {
            ...
            child: Column(
              ...
              children: [
                ...
                AppTextField(
                  ...
                  prefixIcon: Icon(Icons.folder_open_outlined, fontWeight: FontWeight.bold,),
                ),
                const SizedBox(height: 24),
        ...
        child: LiquidGlassContainer(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Delete Folder', 
                style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Theme.of(context).brightness == Brightness.dark ? Colors.white : AppColors.textPrimary)
              ),
              const SizedBox(height: 12),
              Text(
                'Are you sure you want to delete "${folder.name}"? All notes in this folder will be moved to Trash.',
                textAlign: TextAlign.center,
                style: TextStyle(color: Theme.of(context).brightness == Brightness.dark ? Colors.white70 : AppColors.textSecondary, fontSize: 16),
              ),
