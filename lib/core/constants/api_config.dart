abstract final class ApiConfig {
  ...
  static String get foldersUrl => '${_normalizedBaseUrl()}/api/folder';
  static String get saveFolderUrl => '${_normalizedBaseUrl()}/api/folder/save';
  static String get deleteRestoreFolderUrl =>
      '${_normalizedBaseUrl()}/api/folder/delete-restore';
  static String get notesUrl => '${_normalizedBaseUrl()}/api/note';
  static String noteUrl(int id) => '${_normalizedBaseUrl()}/api/note/$id';
  static String get saveNoteContentUrl =>
      '${_normalizedBaseUrl()}/api/note/save-content';
  static String get updateNoteStateUrl =>
