...
class SignupController extends GetxController {
  ...
  Future<void> signup() async {
    ...
    final success = await authService.signup(phone, password);
    ...
    Get.snackbar(
      'Registration Failed',
      authService.lastError ?? 'Please check your information and try again.',
      snackPosition: SnackPosition.TOP,
              ...
              children: [
                ...
                Center(
                  child: Text(
                    ...
                    '${ApiConfig.minimumPasswordLength} characters.',
