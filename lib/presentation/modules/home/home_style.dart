...
class HomeStyle {
  ...
  static const primary = AppColors.magenta;
  static const orange = AppColors.magenta; // Mapped to brand color for consistency
  static const yellow = AppColors.yellow;
  static const red = AppColors.red;
  static const blue = AppColors.magenta; // Unified brand color
  ...
  Color get background => adaptive(
        light: const Color(0xFFF2F2F7), // iOS System Background
        dark: Colors.black,
      );
  ...
  Color get primaryText => adaptive(
        light: Colors.black,
        dark: Colors.white,
      );
  ...
  Color get border => adaptive(
        light: const Color(0xFFC6C6C8),
        dark: const Color(0xFF38383A),
      );

  Color get shadow => Colors.black.withValues(
  ...
  Color get placeholder => adaptive(
