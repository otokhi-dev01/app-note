    ...
    if (!_looksLikeImage(block)) {
      ...
      return Padding(
        ...
        child: _FileTile(
          ...
          onEdit: isPdf ? () => controller.editPdfSourceImage(blockIndex) : null,
          onConvertToImage: isPdf ? () => controller.convertPdfToImage(blockIndex) : null,
        ),
      );
    }
...
class _FileTileState extends State<_FileTile> {
  ...
  Widget build(BuildContext context) {
    ...
    final name = (rawName.isEmpty || _isAutogeneratedName(rawName))
        ...
        : rawName;
    final ext =
        rawName.contains('.') ? rawName.split('.').last.toUpperCase() : '';
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: Icon(
                    widget.isPdf ? CupertinoIcons.doc_richtext : CupertinoIcons.doc,
                    size: 20,
                    color: theme.colorScheme.onSurfaceVariant,
                  ),
                ),
...
class _AudioTileState extends State<_AudioTile> {
  ...
  Widget build(BuildContext context) {
    ...
    final isDark = theme.brightness == Brightness.dark;
    final rawName = widget.block.displayName.trim();
    final name = (rawName.isEmpty || _isAutogeneratedName(rawName)) ? 'Recording' : rawName;
