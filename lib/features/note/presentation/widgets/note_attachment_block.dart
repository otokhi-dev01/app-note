...
bool _isAutogeneratedName(String name) {
  ...
  return cleanName.startsWith('image_picker_') ||
      ...
      cleanName == 'Scan.jpg' ||
      cleanName == 'Scanned Document.pdf';
}
...
class _ImageTileState extends State<_ImageTile> {
      ...
      child: Stack(
        children: [
          lg.GlassMenu(
            ...
            menuWidth: 250,
            // Left to auto-detect: an attachment can sit anywhere in a note,
            // so whether the menu has room to open downward depends on how
            // far the reader has scrolled — unlike the toolbar and app-bar
            // menus, whose triggers are pinned to one edge.
            autoAdjustToScreen: true,
            menuPadding: const EdgeInsets.all(12),
            // The trigger is the picture itself — far larger than the menu —
            // so the body blooms from a point rather than growing out of a
            // glass blob the size of the whole tile.
            morphFromZero: true,
            triggerBuilder: (context, _) => GestureDetector(
              behavior: HitTestBehavior.opaque,
              // Tap still goes straight to the editor; the menu is what the
              // long press is for.
              onTap: widget.onEdit,
  ...
  Widget _buildImage() {
    ...
    final name = block.displayName.trim();
    // Don't show the filename if it's an autogenerated string.
    final showName = name.isNotEmpty && !_isAutogeneratedName(name);
...
class _FileTile extends StatefulWidget {
  ...
  /// Inverse of image-to-pdf conversion.
