...
import 'home_folder_sheet_widget.dart';
...
abstract final class HomeOverlays {
    ...
    await showModalBottomSheet<void>(
      ...
      builder: (BuildContext sheetContext) {
        return FractionallySizedBox(
          heightFactor: 0.78,
          child: Obx(() {
            final int totalNoteCount = controller.activeNotes.isNotEmpty
                ? controller.activeNotes.length
                : controller.folders.fold<int>(0, (int total, folder) {
            ...
            return HomeFolderSheet(
              ...
              onCreateFolder: () {
                ...
                Future<void>.delayed(const Duration(milliseconds: 180), () {
                  ...
                  showCreateFolder(context: context, controller: controller);
                });
              },
            );
          }),
  ...
  static Future<void> showCreateFolder({
    ...
    await controller.createFolder(name: result);
  }
  ...
  static Future<void> showCreateNote({
    ...
    if (controller.folders.isEmpty) {
      await showCreateFolder(context: context, controller: controller);
    ...
    await showCupertinoModalPopup<void>(
      ...
      builder: (BuildContext sheetContext) {
        return CupertinoActionSheet(
          ...
          message: const Text('Choose an account action.'),
          actions: [
