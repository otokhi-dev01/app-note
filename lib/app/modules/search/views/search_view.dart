...
class SearchView extends GetView<sc.SearchController> {
            ...
            child: Material(
              ...
              child: Column(
                ...
                children: [
                  for (
                  int i = 0;
                  i < controller.suggestions.length;
                  i++
                  ) ...[
  ...
  Widget _buildSearchResults(BuildContext context) {
    ...
    return Obx(() {
      /// No search result
      if (controller.noteResults.isEmpty &&
          controller.folderResults.isEmpty) {
        return Center(
          child: Text(
            'No results found',
            style: theme.textTheme.bodyLarge?.copyWith(
          ...
          if (controller.folderResults.isNotEmpty) ...[
            ...
            GlassCard(
              ...
              children: [
                for (
                int i = 0;
                i < controller.folderResults.length;
                i++
                ) ...[
                  GlassListTile(
                    onTap: () {
              ...
              GlassCard(
                ...
                children: [
                  ...
                  i++
                    ...
                    _buildNoteTile(
                      context,
                      controller.pinnedNoteResults[i],
                    ),
