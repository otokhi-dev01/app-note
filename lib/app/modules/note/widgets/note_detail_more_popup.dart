    ...
    return Obx(() => IOSActionMenu(
      ...
      actions: [
        IOSMenuAction(
          ...
          icon: controller.isPinned.value ? CupertinoIcons.pin_slash : CupertinoIcons.pin,
          onTap: controller.togglePin,
        ),
        IOSMenuAction(
          label: controller.isArchived.value ? "Unarchive" : "Archive",
          icon: controller.isArchived.value ? CupertinoIcons.archivebox_fill : CupertinoIcons.archivebox,
          onTap: controller.toggleArchive,
        ),
        IOSMenuAction(
          label: controller.isLocked.value ? "Unlock" : "Lock",
          icon: controller.isLocked.value ? CupertinoIcons.lock_fill : CupertinoIcons.lock,
